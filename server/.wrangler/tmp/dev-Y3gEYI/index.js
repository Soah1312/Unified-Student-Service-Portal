...
// .wrangler/tmp/bundle-ZtgQjM/strip-cf-connecting-ip-header.js
...
var notices = [
  ...
  },
  {
    ...
    priority: "medium",
    content: "A reminder to all students regarding the zero-tolerance anti-ragging policy of the institution. Any complaints can be reported to the Anti-Ragging Committee or via the anonymous helpline 1800-XXX-XXXX. The college takes all complaints seriously.",
    date: "2026-03-10",
...
app.route("/api/notices", notices_default);
...
app.get("/api/health", (c) => {
  return c.json({
    success: true,
    message: "Unified Student Service Portal API is running on Cloudflare Workers \u{1F680}",
    timestamp: (/* @__PURE__ */ new Date()).toISOString(),
...
// .wrangler/tmp/bundle-ZtgQjM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZtgQjM/middleware-loader.entry.ts
